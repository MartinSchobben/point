...
Th function `cor_yield` calculates the yield with a given mean (`M_PHD`), standard deviation (`SD_PHD`), and threshold value for the PHD, and makes use of the package `pPolyaAeppli` [@Burden2014].
